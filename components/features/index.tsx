        ...
        <div className="my-3 col-12 col-sm-6 col-md-4 col-lg-3">
          <div className={styles.feature_item}>
            ...
            <div className={styles.feature_item_info}>
              <Link href="/wallet-connect" className={styles.feature_item_link}>
                Set Up Your Wallet
              </Link>
              <p className={styles.feature_item_overview}>
                Wallet that is functional for NFT purchasing. You may have a Coinbase account
                at this point, but very few are actually set up to buy an NFT.
              </p>
            </div>
          </div>
        </div>
        <div className="my-3 col-12 col-sm-6 col-md-4 col-lg-3">
          <div className={styles.feature_item}>
            ...
            <div className={styles.feature_item_info}>
              ...
              <p className={styles.feature_item_overview}>
                Setting up your NFT collection and creating NFTs on NFTs is easy! This guide
                explains how to set up your first collection.
              </p>
            </div>
          </div>
        </div>
        <div className="my-3 col-12 col-sm-6 col-md-4 col-lg-3">
          <div className={styles.feature_item}>
            ...
            <div className={styles.feature_item_info}>
              ...
              <p className={styles.feature_item_overview}>
                Sed ut perspiciatis un de omnis iste natus error sit voluptatem accusantium
