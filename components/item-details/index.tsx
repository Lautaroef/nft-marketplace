        ...
        <div className="row">
          ...
          <div className="py-md-5 col-12 col-lg-6">
            <div className={styles.item_details}>
              <h3 className={styles.item_title}>The Fantasy Flower illustration</h3>
              ...
              <p className={styles.item_overview}>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Explicabo earum nihil
                neque similique quae eaque beatae eos, alias laborum. Explicabo ex, molestias
                accusantium neque laboriosam eaque distinctio repudiandae a quo!
              </p>
              <div className={styles.item_facts}>
                <div className="row">
                  <div className="my-3 col-12 col-sm-6">
                    <div className={styles.item_fact}>
                      <span className={styles.item_fact_label}>current bid</span>
                  ...
                  <div className="my-3 col-12 col-sm-6">
                    <div className={styles.item_fact}>
                      ...
                      <span className={styles.item_fact_value}>4 : 12 : 34 : 23</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="my-4">
                <Link href={"/login"} className={styles.place_bid_btn}>
